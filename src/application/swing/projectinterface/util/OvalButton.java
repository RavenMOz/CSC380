...
public class OvalButton extends JButton implements MouseListener, MouseMotionListener {
	 ...
	 * 
	 */
	private static final long serialVersionUID = 7561610334137160907L;
    ...
    */
    ...
    public void paintComponent(Graphics g) {
        ...
        gr.setRenderingHints(new RenderingHints(RenderingHints.KEY_TEXT_ANTIALIASING, RenderingHints.VALUE_TEXT_ANTIALIAS_ON));
